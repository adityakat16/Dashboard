...
# Render typically maps internal port 10000
EXPOSE 10000

# Command to run the application using Gunicorn
CMD ["gunicorn", "app:app", "--bind", "0.0.0.0:10000"]# Use a base image that includes Python and has a good foundation for Chrome
FROM python:3.9-slim-buster
